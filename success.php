...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar-dark accordion" id="accordionSidebar" style="background-color: #0C0634">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Congratulations....!!</h3></div>
                                    <div class="card-body">
                                    <div class="col-md-12">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a class="small" href="pay.php">Purchase Again</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
