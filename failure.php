                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Oppss....!!</h3></div>
                                    <div class="card-body">
                                    <div class="col-md-12">
				
						                    <div class="alert alert-warning" role="alert">
						                    	<h4 class="alert-heading">Your have insufficient funds in your wallet. Please contact your agent to refund your wallet!</h4>
						                    </div>
					
			
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="dashboard.php">Return to Dashboard</a>
                                                <a class="small" href="pay.php">Try Again</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
