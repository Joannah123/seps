                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="confirm.php" type="button" class="btn btn-info btn-lg">Confirm New Users</a>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <!-- Trigger the modal with a button -->
                                            <a href="#" type="button" class="btn btn-info btn-lg">Customer Billing Records
                                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="row no-gutters align-items-center">
                                                <!-- Trigger the modal with a button -->
                                                <a href="#" type="button" class="btn btn-info btn-lg">Manage System Users
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <!-- Trigger the modal with a button -->
                                            <a href="#" type="button" class="btn btn-info btn-lg">Manage Complains
                                                </a>
                                        </div>
                                        <div class="col-auto">
