...
if (isset($_POST['submit'])) {
	...
	$d=$_POST['m_no'];
    $Id = $_POST['id'];
	$set="UPDATE user SET fname='$a', lname='$b',sts='$c',meter_no='$d' WHERE id='$Id'";
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Update user info here....!!</h3></div>
                                    <div class="card-body">
                                        <form method="post" action="update.php">
                                            <div class="form-floating mb-3">
                                                <label for="First Name"></label>
                                                <input class="form-control" id="inputEmail" name="fnane" type="text" value="<?php echo $fn ?>"/>
                                                <label for="Last Name"></label>
                                                <input class="form-control" id="inputEmail" name="lname" type="text"  value="<?php echo $ln ?>"/>
                                                <label for="Status"></label>
                                                <input class="form-control" id="inputEmail" name="status" type="text"  value="<?php echo $st ?>"/>
                                                <label for="Meter Number"></label>
                                                <input class="form-control" id="inputEmail" name="m_no" type="text"  value="<?php echo $mn ?>"/>
                                                <input type="hidden" name="id" value="<?php echo $n?>">
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="index.php">Cancel</a>
