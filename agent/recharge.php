                ...
                <div class="col-lg-6 bg-gradient-white">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Recharge Customer here..!</h1>
                        </div>
                        <form class="user" action="index.php" method="post">
                            ...
                            <div class="form-group">
                                <input name="Amount" type="number" class="form-control form-control-user"
                                    id="exampleInputPassword" placeholder="Enter Amount..">
                            </div>
                            <div class="form-group">
                                <input name="meter_no" type="number" class="form-control form-control-user"
                                    id="exampleInputPassword" placeholder="Enter Meter Number..">
                            </div>
                            <div class="form-group">
