                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                                                data-target="#myModal">Agent (Wallet)</button>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <!-- Trigger the modal with a button -->
                                            <a href="recharge.php" type="button" class="btn btn-info btn-lg">Recharge
                                                Customer
                                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="row no-gutters align-items-center">
                                                <!-- Trigger the modal with a button -->
                                                <a href="#" type="button" class="btn btn-info btn-lg">Transactions
                                                    Records
                                                </a>
                                            </div>
                                        </div>
