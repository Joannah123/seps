...
<?php
 ...
 if ($balance>=$prc) {
     ...
     $sql2 = "INSERT INTO `history` (`amount`, `units`, `balance`, `dyt`,`meter_no`) VALUES ('$prc', '$units', '$new', '$dyt','$meter')";
     $rn=mysqli_query($conn,$sql);
     $run=mysqli_query($conn,$sql2);
     if ($rn && $run) {
            $resp = sendSms($mobile, $sms);
            if($resp==100){
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Purchase Electricity here....!!</h3></div>
                                    <div class="card-body">
                                        <form method="post" action="pay.php">
                                            <div class="form-floating mb-3">
                                                <label for="curr_pass"></label>
                                                <input class="form-control" id="inputEmail" name="meter_no" type="text" placeholder="Enter meter number" required="required" />
                                                <label for="new_pass"></label>
                                                <input class="form-control" id="inputEmail" name="price" type="text" placeholder="Enter price" required="required" />
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="dashboard.php">Return to Dashboard</a>
                                                <button class="btn btn-primary" name="submit">Pay</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
